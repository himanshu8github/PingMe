...
const Navbar = () => {
  ...
  // Determine buttons based on current route
      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            ...
            <h1 className="text-gray-900 dark:text-gray-100 text-lg font-bold">
              PingMe
            </h1>
          </Link>
        </div>
        ...
        {authUser ? (
          <div className="flex items-center gap-4">
            {/* Show Profile button on chat route */}
            {isChatRoute && (
            ...
            {/* Show Chat button on profile route */}
            {isProfileRoute && (
